  ...
  (defun decode (c rinst)
	...
	(1 (if (getf microinst :reverse)
		 ...
		 (0 (setf (getf rval :arg0) (ldb (byte 4 4) (car args)))))
	       (case (getf microinst :constarg)
		 (4 (setf (getf rval :arg1) (le-list-to-u32int (subseq args 0 4))
			  (getf rval :arg0) (ldb (byte 4 4) (nth 4 args))))
		 (1 (setf (getf rval :arg1) (le-list-to-u8int (car args))
			  (getf rval :arg0) (ldb (byte 4 4) (cadr args))))
		 (0 (setf (getf rval :arg0) (ldb (byte 4 4) (car args)))))))
